...
public class Bot extends TelegramLongPollingBot {
    ...
    final private String BOT_TOKEN = "6284548078:AAEYNNisx_8-Go6dSJqZgBzeAXVoaiXdNk0";
    final private String BOT_NAME = "GomelCityBot";
    ...
    // На команду 1 - sendMsgcom1 с однима набором кнопок, на команду 2 - sensMsg2 с другим набором кнопок.
    //клавиатура
    void initKeyboard()
    {
        ...
        keyboardRow.add(new KeyboardButton("Помни"));
